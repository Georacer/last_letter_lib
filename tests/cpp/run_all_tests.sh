...
# Run from ws/src/ directory

set -e

test_binary_location="../build/last_letter_lib/"
...
test_list[11]="test_parameters ${uav_name}"
test_list[12]="test_loop_rate ${uav_name}"
test_list[13]="test_trimmer_input ${uav_name}"
test_list[14]="test_trimmer_state ${uav_name}"
