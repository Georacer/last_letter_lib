...
public:
    ...
    Wrench_t wrenchExternal; // For any unmodelled or independent external disturbances
};
...
{
public:
    SimState_t() : pose(), velocity(), rotorspeed(4, 0.01) {}
    ...
    Geoid geoid;
    Pose pose;						// NED. The quaternion offers the Body-to-Earth transformation.
    Twist velocity;					// NED
